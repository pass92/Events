...
public class DbAdapter {
	...
	public long createEvents(String id,String image,String title, String description, String start_time,
		String end_time,String location, String my,String latitude,String longitude) {
		ContentValues initialValues = createContentValues(id,image, title, description, start_time, end_time, location, my,latitude, longitude);
	...
	public boolean updateEvents(String id,String image,String title, String description, String start_time,
			String end_time,String location, String my,String latitude,String longitude) {
	    ContentValues updateValues = createContentValues(id,image, title, description, start_time, end_time, location, my,latitude, longitude);
	...
	public Cursor fetchAllEvents() {
		Cursor cursor= database.query(DbHelper.TABLE_EVENTS, new String[] { DbHelper.COLUMN_ID, DbHelper.COLUMN_IMAGE,DbHelper.COLUMN_TITLE, DbHelper.COLUMN_DESCRIPTION, DbHelper.COLUMN_START_TIME, DbHelper.COLUMN_END_TIME ,DbHelper.COLUMN_LOCATION, DbHelper.COLUMN_MY , DbHelper.COLUMN_LATITUDE , DbHelper.COLUMN_LONGITUDE }, null, null,
				null, null, null);
		return cursor;
	...
	public Cursor fetchEventById(String id){
		Cursor c= database.query(true, DbHelper.TABLE_EVENTS, new String[] { DbHelper.COLUMN_ID, DbHelper.COLUMN_IMAGE,DbHelper.COLUMN_TITLE, DbHelper.COLUMN_DESCRIPTION, DbHelper.COLUMN_START_TIME, DbHelper.COLUMN_END_TIME ,DbHelper.COLUMN_LOCATION, DbHelper.COLUMN_MY ,DbHelper.COLUMN_LATITUDE, DbHelper.COLUMN_LONGITUDE  },DbHelper.COLUMN_ID + "=" + id, null, null, null,null, null, null);
		return c;
	}
	
	//fetch event by is myevent
	public Cursor fetchEventByMy(String my){
		Cursor c= database.query(true, DbHelper.TABLE_EVENTS, new String[] { DbHelper.COLUMN_ID, DbHelper.COLUMN_IMAGE,DbHelper.COLUMN_TITLE, DbHelper.COLUMN_DESCRIPTION, DbHelper.COLUMN_START_TIME, DbHelper.COLUMN_END_TIME ,DbHelper.COLUMN_LOCATION, DbHelper.COLUMN_MY, DbHelper.COLUMN_LATITUDE, DbHelper.COLUMN_LONGITUDE  },DbHelper.COLUMN_MY + "=" + my, null, null, null,null, null, null);
		return c;
	}
	...
	public Cursor fetchEventsByFilter(String filter) {
		Cursor mCursor = database.query(true, DbHelper.TABLE_EVENTS,
				new String[] { DbHelper.COLUMN_ID, DbHelper.COLUMN_IMAGE,DbHelper.COLUMN_TITLE, DbHelper.COLUMN_DESCRIPTION, DbHelper.COLUMN_START_TIME, DbHelper.COLUMN_END_TIME ,DbHelper.COLUMN_LOCATION , DbHelper.COLUMN_MY , DbHelper.COLUMN_LATITUDE, DbHelper.COLUMN_LONGITUDE  },
